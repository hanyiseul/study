...
app.get("/material/edit/:id", (req, res) => {
  ...
  conn.query(sql, [materialId], (err, rows) => {
    ...
    const html = renderTemplate(template, {
      ...
      selected_status_discontinued:
        statusSelectedMap.selected_status_discontinued,
    });
